...
export function Tabuleiro1(props) {
  ...
  const card = shuffleArray([
    {
      url: "cardsJornadaStart/cardJornadaStart1.png",
      pergunta:
        "A agenda 2030 é uma ação global que estabelece os objetivos de desenvolvimento",
      resposta: true,
    },
    {
      url: "cardsJornadaStart/cardJornadaStart2.png",
      pergunta:
        "O pacto global é uma iniciativa da onu para mobilizar empresas a adotarem práticas sustentáveis",
      resposta: true,
    },
    {
      url: "cardsJornadaStart/cardJornadaStart3.png",
      pergunta: "ODS são 15 objetivos de desenvolvimento sustentável",
      resposta: false,
    },
    {
      url: "cardsJornadaStart/cardJornadaStart4.png",
      pergunta:
        "Políticas públicas são projetos e programas desenvolvidos pelos municípios",
      resposta: false,
    },
    {
      url: "cardsJornadaStart/cardJornadaStart5.png",
      pergunta:
        "Os 3 pilares da sustentabilidades são: Ambiental, Social e Econômico",
      resposta: true,
    },
    {
      url: "cardsJornadaStart/cardJornadaStart6.png",
      pergunta: "ESG significa Ambiental, Social e Governança",
      resposta: true,
    },
  ...
  const banner = [
    { url: "cardsJornadaStart/banner1.jpg" },
  ...
  const [posicoes, setPosicoes] = useState([
    {
      ...
      numero: 0,
      card: {
        url: "cardsJornadaStart/card0.png",
        pergunta: null,
        resposta: false,
      },
    },
